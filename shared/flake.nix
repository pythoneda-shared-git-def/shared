  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "shared";
        version = "0.0.1a16";
        sha256 = "sha256-7LJK1xw1fjojRg2hCQHrIPS6aaLskA/CqH9z3ZJokY4=";
        pname = "${org}-${repo}";
      ...
      in rec {
        ...
        devShells = rec {
          ...
          pythoneda-shared-git-shared-raw-python38 = shared.raw-devShell-for {
            package = packages.pythoneda-shared-git-shared-python38;
            python = pkgs.python38;
            pythoneda-shared-pythoneda-banner =
              pythoneda-shared-pythoneda-banner.packages.${system}.pythoneda-shared-pythoneda-banner-python38;
          ...
          pythoneda-shared-git-shared-raw-python39 = shared.raw-devShell-for {
            package = packages.pythoneda-shared-git-shared-python39;
            python = pkgs.python39;
            pythoneda-shared-pythoneda-banner =
              pythoneda-shared-pythoneda-banner.packages.${system}.pythoneda-shared-pythoneda-banner-python39;
          ...
          pythoneda-shared-git-shared-raw-python310 = shared.raw-devShell-for {
            package = packages.pythoneda-shared-git-shared-python310;
            python = pkgs.python310;
            pythoneda-shared-pythoneda-banner =
              pythoneda-shared-pythoneda-banner.packages.${system}.pythoneda-shared-pythoneda-banner-python310;
          ...
          pythoneda-shared-git-shared-raw-python311 = shared.raw-devShell-for {
            package = packages.pythoneda-shared-git-shared-python311;
            python = pkgs.python311;
            pythoneda-shared-pythoneda-banner =
              pythoneda-shared-pythoneda-banner.packages.${system}.pythoneda-shared-pythoneda-banner-python311;
