...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-shared-pythonlang-shell = {
      ...
      inputs.pythoneda-shared-pythonlang-banner.follows =
        "pythoneda-shared-pythonlang-banner";
      url = "github:pythoneda-shared-pythonlang-def/shell/0.0.66";
    };
  };
  outputs = inputs:
    with inputs;
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "shared";
        version = "0.0.16";
        sha256 = "0ni9lr479y2pzzg357qdmcrh76cy4h420xh0z6f50dr018y8ixq1";
        pname = "${org}-${repo}";
        ...
        pythoneda-shared-git-shared-for = { python
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-shared-pythonlang-domain} ${pythoneda-shared-pythonlang-shell}; do
              ...
              for nixpkgsDep in ${dulwich} ${GitPython} ${packaging} ${requests} ${semver}; do
